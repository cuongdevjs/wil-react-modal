...
function (_PureComponent) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_setVisibleModalWithPropVisible",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _this._setModalVisible(isVisible);
    ...
    _defineProperty(_assertThisInitialized(_this), "_createModal", function () {
      var scrollTargetEnabled = _this.props.scrollTargetEnabled;
      var modalId = _this.state.modalId;
      var el = document.createElement("div");
      el.setAttribute("id", "__wil_modal_".concat(modalId, "__"));
      el.setAttribute("data-static", String(scrollTargetEnabled));
    ...
    regenerator.mark(function _callee6() {
      var _this$props, scrollTargetEnabled, onOpenEnd, onOpenEndAsync, animationType, modalId, $modal;

      return regenerator.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _this$props = _this.props, scrollTargetEnabled = _this$props.scrollTargetEnabled, onOpenEnd = _this$props.onOpenEnd, onOpenEndAsync = _this$props.onOpenEndAsync, animationType = _this$props.animationType;
              _context6.next = 3;
            ...
            case 3:
              ...
              $modal = document.getElementById("__wil_modal_".concat(modalId, "__"));

              _this._renderModalDOM();
            ...
            case 17:
              _context6.next = 19;
              return onOpenEndAsync(_this._renderModalDOM);
    ...
    regenerator.mark(function _callee7() {
      var _this$props2, scrollTargetEnabled, animationType, onCloseEnd, modalId, $modal;
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderModalDOM", function () {
      var modalId = _this.state.modalId;
      var $modal = document.getElementById("__wil_modal_".concat(modalId, "__"));

      if ($modal) {
        reactDom.render(React__default.createElement(React__default.Fragment, null, _this._renderModal()), $modal);
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderUnderlay", function () {
      ...
      return underlayEnabled && React__default.createElement("div", {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderModal", function () {
      ...
      return React__default.createElement("div", {
        className: "".concat(styles.modalContent, " ").concat(styles[placement], " ").concat(styles[animationType], " ").concat(fullScreenClassName)
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderStyleAnimated", function () {
      var _this$state = _this.state,
          ...
          modalId = _this$state.modalId;
      return isVisible && React__default.createElement(Helmet, null, React__default.createElement("style", {
        type: "text/css",
        rel: "stylesheet"
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      return this._renderStyleAnimated();
    }
  }]);
...
_defineProperty(Modal, "defaultProps", {
  ...
  onOpenEndAsync: function () {
    var _onOpenEndAsync = _asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee10(onReRender) {
    ...
    function onOpenEndAsync(_x5) {
      return _onOpenEndAsync.apply(this, arguments);
    }

    return onOpenEndAsync;
  }(),
