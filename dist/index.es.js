...
function (_PureComponent) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderStyleAnimated", function () {
      ...
      return isAnimated && React.createElement(Helmet, null, React.createElement("style", {
        type: "text/css",
        rel: "stylesheet"
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      return React.createElement(React.Fragment, null, this._renderStyleAnimated(), this._renderModalPortal());
    }
  }]);
